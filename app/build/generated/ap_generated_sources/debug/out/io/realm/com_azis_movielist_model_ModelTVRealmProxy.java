...
public class com_azis_movielist_model_ModelTVRealmProxy extends com.azis.movielist.model.ModelTV
    implements RealmObjectProxy, com_azis_movielist_model_ModelTVRealmProxyInterface {
    ...
    private ProxyState<com.azis.movielist.model.ModelTV> proxyState;

    com_azis_movielist_model_ModelTVRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.azis.movielist.model.ModelTV>(this);
    ...
    @SuppressWarnings("cast")
    public static com.azis.movielist.model.ModelTV createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.azis.movielist.model.ModelTV obj = realm.createObjectInternal(com.azis.movielist.model.ModelTV.class, true, excludeFields);

        final com_azis_movielist_model_ModelTVRealmProxyInterface objProxy = (com_azis_movielist_model_ModelTVRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.azis.movielist.model.ModelTV createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.azis.movielist.model.ModelTV obj = new com.azis.movielist.model.ModelTV();
        final com_azis_movielist_model_ModelTVRealmProxyInterface objProxy = (com_azis_movielist_model_ModelTVRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.azis.movielist.model.ModelTV copyOrUpdate(Realm realm, com.azis.movielist.model.ModelTV object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.azis.movielist.model.ModelTV) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.azis.movielist.model.ModelTV copy(Realm realm, com.azis.movielist.model.ModelTV newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.azis.movielist.model.ModelTV realmObject = realm.createObjectInternal(com.azis.movielist.model.ModelTV.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_azis_movielist_model_ModelTVRealmProxyInterface realmObjectSource = (com_azis_movielist_model_ModelTVRealmProxyInterface) newObject;
        com_azis_movielist_model_ModelTVRealmProxyInterface realmObjectCopy = (com_azis_movielist_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.azis.movielist.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.azis.movielist.model.ModelTV.class);
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.azis.movielist.model.ModelTV.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_azis_movielist_model_ModelTVRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Name = ((com_azis_movielist_model_ModelTVRealmProxyInterface) object).realmGet$Name();
        if (realmGet$Name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.NameIndex, rowIndex, realmGet$Name, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_azis_movielist_model_ModelTVRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_azis_movielist_model_ModelTVRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_azis_movielist_model_ModelTVRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_azis_movielist_model_ModelTVRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_azis_movielist_model_ModelTVRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_azis_movielist_model_ModelTVRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.azis.movielist.model.ModelTV.class);
        com.azis.movielist.model.ModelTV object = null;
        while (objects.hasNext()) {
            object = (com.azis.movielist.model.ModelTV) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.azis.movielist.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.azis.movielist.model.ModelTV.class);
    ...
    public static com.azis.movielist.model.ModelTV createDetachedCopy(com.azis.movielist.model.ModelTV realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.azis.movielist.model.ModelTV unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.azis.movielist.model.ModelTV();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.azis.movielist.model.ModelTV) cachedObject.object;
            }
            unmanagedObject = (com.azis.movielist.model.ModelTV) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_azis_movielist_model_ModelTVRealmProxyInterface unmanagedCopy = (com_azis_movielist_model_ModelTVRealmProxyInterface) unmanagedObject;
        com_azis_movielist_model_ModelTVRealmProxyInterface realmSource = (com_azis_movielist_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_azis_movielist_model_ModelTVRealmProxy aModelTV = (com_azis_movielist_model_ModelTVRealmProxy)o;
